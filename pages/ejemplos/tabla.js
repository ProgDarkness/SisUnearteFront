...
function Tabla() {
  ...
  const { data, error } = useSWR(
    token ? [GQLPlantilla.GET_PERSONAS, {}, token] : null
  ) */

  const { data, error } = useSWR([GQLPlantilla.GET_PERSONAS, {}])
  ...
  return (
    <AppLayout>
      ...
      >
        <Column field="id_persona" header="ID" />
        <Column field="nb_persona" header="Nombre" />
